...
\begin{figure}
    ...
    \caption{Schematische Darstellung der Energieversorgung (blau: \SI{5}{\volt}; rot: \SI{12}{\volt}; magenta: \SI{230}{\volt}; orange: Daten)} %Bildunterschrift
