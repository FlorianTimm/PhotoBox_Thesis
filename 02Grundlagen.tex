...
\begin{figure}
    \centering
    \includesvg[width=0.8\textwidth]{./img/2_grundlagen/optischeAchse}
...
\begin{figure}
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \centering
        \caption{\Glsentryshort{CCCT} nach \\ \cite{schneider},\\aus Agisoft Metashape}
        \label{img:schneider}
    \end{subfigure}
    \begin{subfigure}{0.45\textwidth}
...
\begin{figure}
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        %\includesvg[height=0.9\linewidth]{./img/2_grundlagen/rueckwaertsschnitt}
        \centering
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        %\includesvg[height=0.9\linewidth]{./img/2_grundlagen/vorwaertsschnitt}
        \centering
...
Mit dem Vorwärts\-schnitt können neben markierten Verknüpfungspunkten auch die Neupunkte, die mittels SIFT oder ähnlichen Bild\-erkennungs\-algorithmen erkannt wurden, berechnet werden. Dadurch kann eine dünne Punktwolke erzeugt werden, welche dann bei der Bündelblockausgleichung (\autoref{s:buendelblock}) genutzt werden kann. Da die Berechnung bereits bei Bildkoordinaten aus zwei Bildern überbestimmt ist und oft Punkte in mehr Bildern abgebildet sind, bietet sich die Nutzung einer Ausgleichung auch schon bei der Bestimmung an. \citep[S. 385]{luhmann}
...
\begin{figure}
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \centering
        \caption{Ungefilterte Punktewolke}
        \label{img:points}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
