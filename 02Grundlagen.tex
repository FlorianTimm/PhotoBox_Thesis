...
Vorteil der Texturierung ist, dass das Modell meist realisitischer wirkt und auch bei fehlenden Informationen, beispielsweise durch fehlende Punkte, eine Oberfläche erzeugt wird. Nachteilig ist, dass die Texturierung hierdurch auch Informationen verdeckt. So kann bei einem nur schattierten Modell die Struktur des 3D-Modelles deutlich besser erkannt werden \citep[S. 702]{luhmann}.
\todo{Beispielbilder}
