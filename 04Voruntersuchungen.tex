...
\paragraph{Vorgehen}
Es wurde jeweils mit dem fertig montierten System, also 24 Raspberry-Pi-Kameras, ein 3D-Modell bei gleich eingestellter Fokussierung mit Agisoft Metashape erzeugt. Hierbei wurden Aruco-Marker genutzt, dessen Position bekannt war (siehe \autoref{sec:kalibrierung}). Es wurde jeweils in Metashape alle Kameras als eine angenommen und die innere Orientierung bestimmt. Die innere Orientierung wurde mit der Fokussierung verglichen.
