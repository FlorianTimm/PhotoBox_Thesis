...
{\large\bfseries Geodäsie und Geoinformatik\\Masterthesis\\Wintersemester 2023/2024}\vspace{2cm}\\
{\large Florian Timm}

% hspace und vspace bedeutet horizontaler bzw. vertikaler Abstand
\vspace{7cm}
Abgabedatum: 01. April 2024
\end{center}
...
Das Erzeugen des 3D-Modelles basiert auf der Technik einer Structure-from-Motion-Pipeline (siehe \autoref{img:ablauf}, vgl. \citealt[S. 491]{luhmann}). Auf die einzelnen Schritte wird in den folgenden Absätzen eingegangen.
