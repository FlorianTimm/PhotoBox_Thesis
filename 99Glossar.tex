...
\newacronym[
    description={Representational State Transfer, Architekturstil für verteilte Systeme, oft in Verbindung mit Webanwendungen verwendet, basiert auf dem \gls{HTTP}-Protokoll, Zustand wird mit übertragen, sodass dieser nicht gespeichert werden muss}]{REST}{REST}{Representational-State-Transfer}

\newacronym{px}{px}{Pixel}

\newacronym{VPE}{VPE}{Verpackungseinheit}
