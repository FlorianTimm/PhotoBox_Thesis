...
\begin{enumerate}[label=N\arabic*]
    ...
    \item \label{e:wlan} Jegliche \todo{Daten-}Kommunikation soll über WLAN erfolgen.
\end{enumerate}
...
\begin{figure}
    ...
    \caption{Screenshot der Connector-Software unter Ubuntu 24.04 \todo{beispielhaft}}
