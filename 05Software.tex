...
\begin{enumerate}[label=F\arabic*]
  ...
  \item Die Steuerung soll unabhängig von anderen Geräten möglich sein, beispielsweise per Tastensteuerung.
...
\begin{enumerate}[label=N\arabic*]
  ...
  \item Jegliche Kommunikation soll über WLAN erfolgen.
\end{enumerate}
