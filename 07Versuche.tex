...
\begin{figure}
    ...
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=1\textwidth]{img/bild_moai.jpg}
        \caption{Moai}
        \label{img:bild_moai}
    \end{subfigure}
    \begin{subfigure}{0.32\textwidth}
    ...
    \end{subfigure}
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=1\textwidth]{img/bild_einstein}
        \caption{Einstein}
...
Bei dem verwendeten System werden zwei Kameras eingesetzt, die sich ein massives Gehäuse mit dem mittig angeordneten Projektor teilen. Je nach verwendeten Messvolumen und Objektentfernung beträgt die Genauigkeit etwa 0,01 - 0,03~mm \citep{atos}. Aufgrund der deutlich höheren erwarteten Genauigkeit des Streifenprojektionssystems, kann davon ausgegangen werden, dass die Messungen deutlich genauer sind als die des Prototyps und als quasi-wahre Werte angenommen werden können.
...
\paragraph{Moai}
Beim Moai (\autoref{img:differenz_moai_einzel}) sind die größten Fehlstellen im Bereich des Kinnes und unterhalb des Bauches zu erkennen. Abweichungen im Bereich des restlichen Körpers sind deutlich geringer und liegen im Bereich von 0,21~mm. Sie sind auf die schlechtere Erfassung der nach unten gerichteten Flächen zurückzuführen. Diese Bildbereiche sind nur in wenigen Bildern sichtbar und können daher nicht so gut rekonstruiert werden. Weitere Abweichungen sind im Bereich der Passpunktmarken zu erkennen, hier ist unklar, welche Daten korrekt sind (vgl. \autoref{s:referenzdaten}).

\paragraph{Testy}
Das Modell des Testy (\autoref{img:differenz_testy}) ist kaum erkennbar. Die weiße und sich wiederholenden Oberfläche führte zu schlechten Ergebnissen. \todo{Text}

\paragraph{Einstein}
Das Modell von Einstein (\autoref{img:differenz_einstein}) zeigt ebenfalls größere Abweichungen im Bereich des Kinnes und des Halses. Die Abweichungen sind hier jedoch deutlich geringer. Die Passpunktmarken sind zwar auch in der Differenzdarstellung erkennbar, jedoch nicht mit so großen Abweichungen wie beim Moai.
\todo{Text}
...
\begin{figure}
    ...
    \begin{subfigure}{0.27\textwidth}
        \includegraphics[width=1\textwidth]{img/cam_anzahl/normal.png}
        \caption{Moai}
    ...
    \end{subfigure}
    \begin{subfigure}{0.27\textwidth}
        \includegraphics[width=1\textwidth]{img/einstein_diff.png}
        \caption{Einstein}
...
\todo{Auf Drehungen detaillierter eingehen}
...
\begin{table}
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{l|l|l|l|l|l|l|l|l}
            ...
            ATOS 5         & \cellcolor[HTML]{EEEEEE}                                          & \cellcolor[HTML]{EEEEEE} & \cellcolor[HTML]{EEEEEE} & \cellcolor[HTML]{EEEEEE}                                            & \cellcolor[HTML]{EEEEEE}                                            & 346830               & 100,0~\%                       & 100,0~\%                       \\ \hline
            Automatik      & 24                                                                & 1                        & 24                       & 0,18~mm                                                             & 2,52~mm                                                             & 628727               & 93,1~\%                        & 99,9~\%                        \\
            Feinschritt    & 24                                                                & 4 x $\frac{1}{32}$       & 96                       & 0,14~mm                                                             & 1,42~mm                                                             & 758364               & 100,2~\%                       & 100,0~\%                       \\
            Grobschritt    & 24                                                                & 5 x $\frac{1}{8}$        & 120                      & 0,16~mm                                                             & \cellcolor[HTML]{EEEEEE}                                            & 777533               & 98,8~\%                        & 100,0~\%                       \\ \hline
            2 von 3        & 16                                                                & 1                        & 16                       & {\color[HTML]{FF0000} 1,20~mm}                                      & {\color[HTML]{FF0000} 7,74~mm}                                      & 596979               & {\color[HTML]{FF0000} 68,4~\%} & {\color[HTML]{FF0000} 70,4~\%} \\ \hline
            jede zweite K. & 12                                                                & 1                        & 12                       & 0,49~mm                                                             & 4,01~mm                                                             & 346830               & {\color[HTML]{FF0000} 54,9~\%} & 94,1~\%                        \\
            … mit Drehung  & 12                                                                & 2 x $\frac{1}{8}$        & 24                       & 0,25~mm                                                             & 1,44~mm                                                             & 760538               & 95,7~\%                        & 99,8~\%                        \\ \hline
            eine Ebene     & 6                                                                 & 4 x $\frac{1}{8}$        & 24                       & {\color[HTML]{FF0000} 1,57~mm}                                      & 1,44~mm                                                             & 753062               & {\color[HTML]{FF0000} 77,8~\%} & {\color[HTML]{FF0000} 68,6~\%} \\
            … mit Markern  & 6                                                                 & 5 x $\frac{1}{8}$        & 30                       & 0,29~mm                                                             & 2,50~mm                                                             & 640810               & 94,2~\%                        & 98,9~\%
        \end{tabular}
    }
\end{table}
