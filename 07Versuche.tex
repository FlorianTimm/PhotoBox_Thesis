...
\begin{table}
    ...
    \begin{tabular}{l|r|r|r}
        ...
        \midrule
        Punktwolke & \SI{0,04}{\milli\metre} & \SI{0,21}{\milli\metre} & \SI{3,3}{\milli\metre} \\  % Vertices neu
        \midrule
        Nikon D90  & \SI{0,27}{\milli\metre} & \SI{0,19}{\milli\metre} & \SI{1,2}{\milli\metre} \\
        \bottomrule
    \end{tabular}
\end{table}
\todo{Testy/Einstein}
