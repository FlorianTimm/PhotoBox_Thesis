...
\begin{figure}
    ...
    \label{img:differenz}
\end{figure}
\todo{Bild Testy tauschen, noch alt}
...
In \autoref{img:differenz_moai_drehteller} ist das Differenzbild des Moai zu sehen. Es zeigt sich, dass die Genauigkeit des Modells mit Drehteller deutlich besser ist, als die des Modells ohne Drehteller (\autoref{img:differenz_moai_einzel}). Auch ist die visuelle Vollständigkeit deutlich höher, die nach unten gerichteten Flächen sind auch erfasst und passen gut zu dem Modell des Streifenprojektionssystems. Die Anzahl der Punkte hat sich nicht relevant verändert -- im Vergleich zu dem vollständigen Modell der Spiegelreflexkamera zeigt sich, dass über die Punktanzahl selbst keine sinnvollen Aussagen zur Abdeckung getroffen werden können.
...
\begin{figure}
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=0.95\linewidth]{img/kameraPosition/blick_von_oben_alle.png}
        \caption{
            24 Kameras,\\
    ...
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=0.95\linewidth]{img/kameraPosition/blick_von_oben_zweidrittel.png}
        \caption{
            16 Kameras \\
            keine Drehung \\
            ~
    ...
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=0.95\linewidth]{img/kameraPosition/blick_von_oben_jedeZweite.png}
        \caption{
            12 Kameras, \\
    ...
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=0.95\linewidth]{img/kameraPosition/blick_von_oben_ebene.png}
        \caption{
            6 Kameras, \\
...
\todo{Auf Drehungen detaillierter eingehen, Musterkameras beschreiben, bisher in nächstem Absatz}
